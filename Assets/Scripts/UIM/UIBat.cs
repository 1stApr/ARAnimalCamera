...
public class UIBat : MonoBehaviour
{
	...
	public void RotationRightButton()
	{
		...
		GameObject.FindWithTag("ModelBat").transform.Rotate(0, -rotationSpeed * Time.deltaTime, 0);
	}
	...
	public void ScaleUpButton()
	{
		...
		GameObject.FindWithTag("ModelBat").transform.localScale += new Vector3(scalingSpeed, scalingSpeed, scalingSpeed);
	}
	...
	{
		GameObject.FindWithTag("ModelBat").transform.Translate(0, 0, -translationSpeed * Time.deltaTime);
	}
	...
	{
		GameObject.FindWithTag("ModelBat").transform.Translate(-translationSpeed * Time.deltaTime, 0, 0);
	}

	public void PositionLeftButton()
	{
		GameObject.FindWithTag("ModelBat").transform.Translate(translationSpeed * Time.deltaTime, 0, 0);  // backward
	}
