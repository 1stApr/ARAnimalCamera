...
public class UIDeer : MonoBehaviour
{
	...
	void RRight()
	{
		GameObject.FindWithTag("ModelDeer").transform.Rotate(0, -rotationSpeed * Time.deltaTime, 0);
	}
	void RLeft()
	{
		GameObject.FindWithTag("ModelDeer").transform.Rotate(0, rotationSpeed * Time.deltaTime, 0);
	...
	void SDown()
	{
		GameObject.FindWithTag("ModelDeer").transform.localScale += new Vector3(-scalingSpeed, -scalingSpeed, -scalingSpeed);
	}
	void PUp()
	{
		GameObject.FindWithTag("ModelDeer").transform.Translate(0, 0, -translationSpeed * Time.deltaTime);
	}
	void PDown()
	{
	...
	void PRight()
	{
		GameObject.FindWithTag("ModelDeer").transform.Translate(-translationSpeed * Time.deltaTime, 0, 0);
	}
	void PLeft()
	{
		GameObject.FindWithTag("ModelDeer").transform.Translate(translationSpeed * Time.deltaTime, 0, 0);
