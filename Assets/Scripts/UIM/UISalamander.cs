...
public class UISalamander : MonoBehaviour
{
	public float scalingSpeed = 0.03f;
	public float rotationSpeed = 70.0f;
	public float translationSpeed = 5.0f;
	//	public GameObject ModelSalamander;
	...
	void RRight()
	{
		GameObject.FindWithTag("ModelSalamander").transform.Rotate(0, -rotationSpeed * Time.deltaTime, 0);
	}
	void RLeft()
	{
		GameObject.FindWithTag("ModelSalamander").transform.Rotate(0, rotationSpeed * Time.deltaTime, 0);
	...
	void SDown()
	{
		GameObject.FindWithTag("ModelSalamander").transform.localScale += new Vector3(-scalingSpeed, -scalingSpeed, -scalingSpeed);
	}
	void PUp()
	{
		GameObject.FindWithTag("ModelSalamander").transform.Translate(0, 0, -translationSpeed * Time.deltaTime);
	}
	void PDown()
	{
	...
	void PRight()
	{
		GameObject.FindWithTag("ModelSalamander").transform.Translate(-translationSpeed * Time.deltaTime, 0, 0);
	}
	void PLeft()
	{
		GameObject.FindWithTag("ModelSalamander").transform.Translate(translationSpeed * Time.deltaTime, 0, 0);
