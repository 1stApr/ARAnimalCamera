...
public class UICrab : MonoBehaviour
{
	...
	void RRight()
	{
		GameObject.FindWithTag("ModelCrab").transform.Rotate(0, -rotationSpeed * Time.deltaTime, 0);
	}
	void RLeft()
	{
		GameObject.FindWithTag("ModelCrab").transform.Rotate(0, rotationSpeed * Time.deltaTime, 0);
	...
	void SDown()
	{
		GameObject.FindWithTag("ModelCrab").transform.localScale += new Vector3(-scalingSpeed, -scalingSpeed, -scalingSpeed);
	}
	void PUp()
	{
		GameObject.FindWithTag("ModelCrab").transform.Translate(0, 0, -translationSpeed * Time.deltaTime);
	}
	void PDown()
	{
	...
	void PRight()
	{
		GameObject.FindWithTag("ModelCrab").transform.Translate(-translationSpeed * Time.deltaTime, 0, 0);
	}
	void PLeft()
	{
		GameObject.FindWithTag("ModelCrab").transform.Translate(translationSpeed * Time.deltaTime, 0, 0);
