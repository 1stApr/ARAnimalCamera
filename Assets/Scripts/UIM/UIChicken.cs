...
public class UIChicken : MonoBehaviour
{
	...
	void RRight()
	{
		GameObject.FindWithTag("ModelChicken").transform.Rotate(0, -rotationSpeed * Time.deltaTime, 0);
	}
	void RLeft()
	{
		GameObject.FindWithTag("ModelChicken").transform.Rotate(0, rotationSpeed * Time.deltaTime, 0);
	...
	void SDown()
	{
		GameObject.FindWithTag("ModelChicken").transform.localScale += new Vector3(-scalingSpeed, -scalingSpeed, -scalingSpeed);
	}
	void PUp()
	{
		GameObject.FindWithTag("ModelChicken").transform.Translate(0, 0, -translationSpeed * Time.deltaTime);
	}
	void PDown()
	{
	...
	void PRight()
	{
		GameObject.FindWithTag("ModelChicken").transform.Translate(-translationSpeed * Time.deltaTime, 0, 0);
	}
	void PLeft()
	{
		GameObject.FindWithTag("ModelChicken").transform.Translate(translationSpeed * Time.deltaTime, 0, 0);
