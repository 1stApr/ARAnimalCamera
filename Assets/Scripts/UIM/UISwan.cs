...
public class UISwan : MonoBehaviour
{
	...
	void RRight()
	{
		GameObject.FindWithTag("ModelSwan").transform.Rotate(0, -rotationSpeed * Time.deltaTime, 0);
	}
	void RLeft()
	{
		GameObject.FindWithTag("ModelSwan").transform.Rotate(0, rotationSpeed * Time.deltaTime, 0);
	...
	void SDown()
	{
		GameObject.FindWithTag("ModelSwan").transform.localScale += new Vector3(-scalingSpeed, -scalingSpeed, -scalingSpeed);
	}
	void PUp()
	{
		GameObject.FindWithTag("ModelSwan").transform.Translate(0, 0, -translationSpeed * Time.deltaTime);
	}
	void PDown()
	{
	...
	void PRight()
	{
		GameObject.FindWithTag("ModelSwan").transform.Translate(-translationSpeed * Time.deltaTime, 0, 0);
	}
	void PLeft()
	{
		GameObject.FindWithTag("ModelSwan").transform.Translate(translationSpeed * Time.deltaTime, 0, 0);
